...
export default function AllRestaurantCard({ item }) {
  ...
  return (
    ...
    >
      <View className="mt-2 mb-4 bg-white rounded-3xl shadow-lg">
        <Image className="h-32 rounded-t-3xl" source={{ uri: url }} />
