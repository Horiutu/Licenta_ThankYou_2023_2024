  ...
  const navigation = useNavigation();
    return(
       <TouchableWithoutFeedback onPress={()=> navigation.navigate('Restaurant')}>
         <View
            className="mr-6 ml-6 mb-4 bg-white rounded-3xl shadow-lg">
          <Image  className="rounded-t-3xl" source={require("../assets/images/Restaurant2.webp")}
                    style={{
                        resizeMode: 'cover',
                        height: 100,
                        width: 345
        ...
        <View className="px-3 pb-4 space-y-2">
          ...
          <View className="flex-row items-center space-x-1">
              ...
              <Text className="text-xs">
                  ...
                  <Text className="text-gray-700"> (reviews)</Text> · <Text className="font-semibold text-gray-700"></Text>
              </Text>
          </View>
          <View className="flex-row items-center space-x-1">
